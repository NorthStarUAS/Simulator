...
class nzu_controller():
    def __init__(self):
        ...
        # helper
        self.az_helper = NotaPID("pitch", min_vc, max_vc, integral_gain=0.01, antiwindup=1.0, neutral_tolerance=0.03, hold_gain=-0.01, debug=True)

        # integrators
        self.integrator = 0.0

        # damper gains
        self.az_damp_gain = 0.0
    ...
    def update(self, load_factor_request):
        ...
        pitch_damp = az * self.az_damp_gain / qbar
