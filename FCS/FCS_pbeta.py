...
class FCS_pbeta():
    ...
    def update(self):
        ...
        # conditions, etc.
        self.aileron_int = self.roll_helper.integrator(ref_p, self.p, self.flying_confidence)
        self.rudder_int = self.yaw_helper.integrator(ref_beta, self.beta_deg, self.flying_confidence)
        # print("integrators: %.2f %.2f %.2f" % (self.aileron_int, elevator_int, self.rudder_int))  # move outside
